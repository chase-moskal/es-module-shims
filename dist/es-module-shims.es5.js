...
(function () {
  ...
  function resolvePackages(pkgs, baseUrl) {
    ...
    for (var p in pkgs) {
      var value = pkgs[p];
      if (Array.isArray(value)) value = value.find(function (v) {
        return !v.startsWith('std:');
      });
      if (typeof value === 'string') outPkgs[resolveIfNotPlainOrUrl(p, baseUrl) || p] = resolveUrl(value, baseUrl);
    }
  ...
  function resolveImportMap(id, parentUrl, importMap) {
    ...
    var scopeName = importMap.scopes && getMatch(parentUrl, importMap.scopes);
  ...
  var WorkerShim = function WorkerShim(aURL) {
    ...
    _classCallCheck(this, WorkerShim);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 29:
              ...
              if (res.url.endsWith('.json')) source = "export default JSON.parse(".concat(JSON.stringify(source), ")");
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 5:
                    ...
                    importShim.map = (0, _context4.t0)(_context4.t1, _context4.t2);
      ...
      return regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 3:
              return _context9.abrupt("return", resolveImportMap(id, parentUrl, importShim.map));
